# Render .gifs of shapes interpolated between a rectangle and an ellipse with a continously moving texture, different orientations, brightnesses, and texture movement directions
